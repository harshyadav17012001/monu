...
const Header: React.FC<HeaderProps> = ({ isDark, toggleTheme }) => {
  ...
  <img src="1.png" alt="Smriti Logo Light" className="h-20 w-auto inline dark:hidden" />
  <img src="2.png" alt="Smriti Logo Dark" className="h-20 w-auto hidden dark:inline" />
</h1>
